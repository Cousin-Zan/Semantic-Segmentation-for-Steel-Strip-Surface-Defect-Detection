...
class VovNet_shortcut(object):
    def __init__(self,
        ...
        config_stage_ch = {'VovNet57_shortcut': [128, 160, 192, 224]}
        config_concat_ch = {'VovNet57_shortcut': [256, 512, 768, 1024]}
        block_per_stage = {'VovNet57_shortcut': [1, 1, 4, 3]}
        layer_per_block = {'VovNet57_shortcut': 5}
